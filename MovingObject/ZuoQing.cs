...
namespace vet
{
    class ZuoQing : NPC
    {
        ...
        public ZuoQing() : base("zuoQing")
        {
            inventory = new StoreInventory("herbsMarket");
            ...
            standPos = new Vector2(2700, 600);
            standPos = new Vector2(23 * 32 - 23 * 32 % Map.TILE_WIDTH + 4, 9 * 32 - 9 * 32 % Map.TILE_HEIGHT + 12);
